  ...
  return (
    <div className={'grid place-items-center h-screen py-2'}>
     ...
     <div className="w-8/12 ">
       ...
       <div className='w-11/12 bg-slate-300 rounded-lg h-10 flex  items-center mb-3 ' >
        ...
        <div className='flex gap-1 h-full justify-center items-center  '>
          <div className="bg-slate-200 rounded-sm w-7 h-7 grid place-items-center"> <svg xmlns="http://www.w3.org/2000/svg" fill='#9CA3AF' viewBox="0 0 20 20"><path d="M12.452 4.516c.446.436.481 1.043 0 1.576L8.705 10l3.747 3.908c.481.533.446 1.141 0 1.574-.445.436-1.197.408-1.615 0-.418-.406-4.502-4.695-4.502-4.695a1.095 1.095 0 0 1 0-1.576s4.084-4.287 4.502-4.695c.418-.409 1.17-.436 1.615 0z"/></svg></div>
          <div className="bg-slate-200 rounded-sm w-7 h-7 grid place-items-center"> <svg xmlns="http://www.w3.org/2000/svg" fill='#9CA3AF' viewBox="0 0 20 20"><path d="M9.163 4.516c.418.408 4.502 4.695 4.502 4.695a1.095 1.095 0 0 1 0 1.576s-4.084 4.289-4.502 4.695c-.418.408-1.17.436-1.615 0-.446-.434-.481-1.041 0-1.574L11.295 10 7.548 6.092c-.481-.533-.446-1.141 0-1.576.445-.436 1.197-.409 1.615 0z"/></svg> </div>
        <div className="mx-4 bg-slate-200 rounded-sm w-7 h-7 grid place-items-center" ></div>
        </div>
        <div className='bg-white rounded-full w-7/12 h-8  flex items-center  mr-12 '>
        <div className="rounded-full w-5 h-5 bg-slate-400 ml-1 mr-4 "></div> 
        <div className='text-gray-600  text-sm italic '> https:// </div>
          <input 
            type="text" 
       ...
       <button 
       className='bg-pink-500 rounded py-2 px-5 my-3 '
       onClick={postUrl}
       disabled={loading}
       >Shorten</button>
     </div>
